...
import plugin.arxtec.LogiBlocksPlus.Commands.BaseCommandListener;
import plugin.arxtec.LogiBlocksPlus.Commands.ForCommandListener;
import plugin.arxtec.LogiBlocksPlus.Commands.LogiCommandListener;
import plugin.arxtec.LogiBlocksPlus.Listeners.LogiBlocksCraftListener;
import plugin.arxtec.LogiBlocksPlus.Listeners.LogiBlocksInteractListener;
import plugin.arxtec.LogiBlocksPlus.Listeners.LogiBlocksRedstoneListener;
import plugin.arxtec.LogiBlocksPlus.Listeners.LogiFlagListener;
			...
			switch(ent.getType())
			{
				...
				case HORSE:
					...
					if( dataPiece.toUpperCase().equals("SKELETON_HORSE") || dataPiece.toUpperCase().equals("UNDEAD_HORSE"))
					{
						...
						//declaring set name example
						//((Horse)ent).setCustomName("Random Name");
					}
					((Horse)ent).setVariant(horseVariant);
					break;
				case ZOMBIE:
					if( dataPiece.toUpperCase().equals("BABY"))
					{
						((Zombie)ent).setBaby(true);
					}
					else if( dataPiece.toUpperCase().equals("VILLAGER"))
					{
